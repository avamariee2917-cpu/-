...
![PostgreSQL](https://img.shields.io/badge/-PostgreSQL-%23336791?logo=postgresql\&logoColor=white\&style=flat-square)
...
> migration step — just deploy/restart. To disable auto-migration set`AUTO_MIGRATE=false`. You can still run a manual key migration locally with
